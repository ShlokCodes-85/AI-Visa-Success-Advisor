...
class Settings:
    ...
    LLM_PROVIDER = os.getenv("LLM_PROVIDER", "openai")  # openai, deepseek, gemini, anthropic, local, xai
    LLM_API_KEY = os.getenv("LLM_API_KEY", "")
    LLM_MODEL = os.getenv("LLM_MODEL", "gpt-3.5-turbo")
    
    # LLM Configuration for Form Mode (can be different from chat mode)
    FORM_LLM_PROVIDER = os.getenv("FORM_LLM_PROVIDER", "openai")  # openai, deepseek, gemini, anthropic, local, xai
