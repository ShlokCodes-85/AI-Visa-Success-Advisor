...
export default function IntendedCourse({ formData, handleInputChange, errors = {}, onClearSection }) {
  return (
    <div>
      <div className="flex justify-between items-center mb-2">
        <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Intended Course & University</h2>
        {onClearSection && (
          <button
